...
_Which attraction had the most number of visitors in 2022? The crown estate, windsor great park._
```{r Q3}
...
_What are the top 10 most visited attractions in 2021? crown estate, royal botanic gardens, natural history museum, etc _
```{r Ex_c}
visitors %>% 
  arrange(desc(n_2021)) %>%
  head(n = 10)
...
_What is the admission charge for the `"National Museum of Scotland"`? free _
...
_How many attraction had more than 1 million visitors in 2022? 22 _
...
```{r Ex_h}
visitors %>% 
summarise( mean_2021 = mean(n_2021)    , median_2021 = mean(n_2021)
